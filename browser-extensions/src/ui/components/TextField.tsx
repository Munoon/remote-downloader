  ...
  function TextFieldRoot(
    ...
    return (
      ...
      >
        ...
        <div
          className={SubframeUtils.twClassNames(
            "flex h-8 w-full flex-none items-center gap-1 border border-solid border-neutral-border bg-default-background px-2 rounded-sm group-focus-within/be48ca43:border group-focus-within/be48ca43:border-solid group-focus-within/be48ca43:border-brand-primary",
            {
